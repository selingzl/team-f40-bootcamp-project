        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            gradient: RadialGradient(
              colors: [Color.fromRGBO(185, 187, 223, 1),
            ...
            child: Container(
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      IconButton(
                        ...
                        icon: Icon(FontAwesomeIcons.caretLeft),color:Color.fromRGBO(135, 142, 205, 1) ,),
                      SizedBox(width: 55,),
                      Text('Kayıt Ol', textAlign: TextAlign.center,
                  ...
                  Column(
                    children: [
                      Image.asset('lib/assets/aPngtreeahand_drawn_cute_cat_reading_4361091.png',height: 90,width: 90,),
                      ElevatedButton(
                        style: ButtonStyle(
